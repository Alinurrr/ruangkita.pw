...
<html lang="en">
  <head>
    <title>RungKita.com Tempat Cari Ruang Meeting Terasik</title>
    <meta charset="utf-8">
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus"><i class="fa fa-whatsapp" aria-hidden="true"></i> </span> <a href="#">&nbsp; +62 8587 8938 836</a><font color="black"> &nbsp;&nbsp; Atau &nbsp;&nbsp; </font> <span class="mailus"><i class="fa fa-envelope-o" aria-hidden="true"></i></span> <a href="#">&nbsp; ruangkita@gmail.com</a></p>
						</div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="index_booking.php" class="nav-link">About</a></li>
