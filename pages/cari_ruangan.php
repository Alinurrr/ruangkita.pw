      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
            <h2  class="subheading"><font color="white">Selamat Datang DiRuangKita.com</font></h2>
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading"><?php echo ($r['nama_ruangan'])?></h3>
                 ...
                 <p><span><font color="#fa6e83"><b>  Tipe: </b></font></span> 
                    ...
                    <span><font color="#fa6e83"><b>  alamat: </b></font></span>  <?php echo ($r['alamat'])?>
                  </p>

                <p> <?php echo ($r['deskripsi'])?></p>
                <p><a href="index_Detail_ruangan.php" class="btn btn-primary">Selengkapnya</a></p>
              </div>
